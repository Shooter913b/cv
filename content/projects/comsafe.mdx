...
links:
  - { label: 'Live Demo', href: 'https://comsafe.netlify.app', type: 'demo' }
  - { label: 'View Notes', href: '#demo-notes', type: 'anchor' }
impact:
...
gallery:
  - '/projects/comsafe/dashboard.png'
  - '/projects/comsafe/map-view.png'
  - '/projects/comsafe/alerts.png'
